 ...
 * @param {string} scm Type of SCM to which <code>repoUrl</code> refers.
 ...
 */
exports.parseAppveyorRepoUrl = function parseAppveyorRepoUrl(scm, repoUrl) {
  if (scm === 'mercurial' || scm === 'subversion') {
    return {
      repositoryScm: scm,
      repositoryType: scm,
 ...
 */
exports.repoUrlToBadgeParams = function repoUrlToBadgeParams(scm, repoUrl) {
  var avRepo = exports.parseAppveyorRepoUrl(scm, repoUrl);
